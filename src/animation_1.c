...
/*   Updated: 2024/03/15 13:42:25 by mbest            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	animation_update(void *param)
{
	...
	opps_frame = (data->anim_counter[0]++ / 8000) % 4;
	exit_frame = (data->anim_counter[1]++ / 8000) % 4 + 1;
	col_frame = (data->anim_counter[2]++ / 8000) % 4;
